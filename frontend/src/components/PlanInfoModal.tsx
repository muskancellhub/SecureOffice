  ...
  return (
    <div className="pim-overlay" role="dialog" aria-modal="true" aria-label={`${planName} details`} onClick={onClose}>
      <style>{`
        ...
        .pim-eyebrow { font-size: 12px; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; color: #c9056d; }
        ...
        .pim-section h4 { margin: 0 0 8px; font-size: 13.5px; font-weight: 700; color: #c9056d; }
        ...
        .pim-section li::before { content: '•'; position: absolute; left: 0; color: #c9056d; }
        ...
        .pim-dot.on { width: 22px; background: #c9056d; }
        ...
        .pim-next.cta { background: linear-gradient(135deg, #e1067d, #c9056d); box-shadow: 0 10px 24px rgba(225, 6, 125, 0.3); }
